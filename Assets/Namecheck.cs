...
public class Namecheck : MonoBehaviour {
    ...
    protected virtual void InitializeFirebase()
    {
        ...
        app.SetEditorDatabaseUrl("https://unity-ec9f0.firebaseio.com/");
    ...
    TransactionResult AddScoreTransaction(MutableData mutableData)
    {
        ...
        /*newScoreMap["score"] =obj.GetHashCode(); ;
        newScoreMap["email"] = obj.name;*/
    ...
    public void AddScore(int id, String name)
    {
        score = id;
        email = name;
